    ...
    return (
        <div className="container mx-auto p-6 bg-gray-100 min-h-screen">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
                ...
                <p className="mb-4"><strong>Amount:</strong> ₹ {data?.order?.total.toFixed(2)}</p>
                        ...
                        <tbody>
                            {data?.order.orderItems.map(item => (
                                <tr key={item.productId} className="hover:bg-gray-50">
                                    ...
                                    <td className="py-3 px-4 border-b border-gray-300 text-sm">₹ {item.price.toFixed(2)}</td>
                                    <td className="py-3 px-4 border-b border-gray-300 text-sm">₹ {(item.quantity * item.price).toFixed(2)}</td>
                                </tr>
                            ))}
                        </tbody>
                    </table>
