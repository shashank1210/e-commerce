      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          ...
          <div className="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-4 my-4">
            <Link
              to="/products"
              className="border-2 border-yellow-500 text-yellow-500 px-4 py-2 rounded-lg text-center hover:bg-yellow-500  hover:text-white transition"
            >
              Continue shopping
            </Link>
            {cartItems.length > 0 && (
        ...
        <div className="lg:col-span-1">
          <div className="bg-blue-50 p-4 rounded-lg shadow-sm">
            ...
            <div className="flex flex-col md:flex-row mb-4 space-y-2 md:space-y-0 md:space-x-2">
              ...
              {appliedCoupon ? (
                ...
                <button
                  ...
                  className="bg-yellow-500 text-white p-2 rounded-lg hover:bg-yellow-400 transition md:w-auto"
            ...
            <Link
              to="/shipping"
              className="p-2 bg-yellow-500 text-white w-full py-2 rounded-lg block text-center hover:bg-yellow-400 transition"
            >
              Proceed to checkout
            </Link>
          </div>
